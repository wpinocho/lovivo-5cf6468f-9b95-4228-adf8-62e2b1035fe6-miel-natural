  ...
  return (
    <section className="py-16 bg-gradient-to-br from-warm/30 via-lavender/20 to-muted/25">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Grid Layout Uniforme y Dinámico */}
        <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
          {galleryImages.map((image, index) => (
            <div
              key={index}
              className={`group relative overflow-hidden rounded-xl border border-accent/30 shadow-md hover:shadow-xl transition-all duration-300 hover:scale-[1.02] bg-gradient-to-br from-primary/5 to-accent/5 ${image.className}`}
